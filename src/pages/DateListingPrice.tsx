                ...
                <div className="col-12">
                    <div className="form-check">
                        <input className="form-check-input" type="checkbox" checked={props.selected} id={`route_name` + props.index}
                            onChange={(e) => props.handleChange1(e.target.name, e.target.checked, props.index)} />
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="ps-sm-4">
                                    ...
                                    <div className="price-input d-flex gap-3 align-items-center">
                                        <input type="email" className="form-control" name="installments" value={props.installments} onChange={(e) => props.handleChange1(e.target.name, e.target.value.replace(/[^0-9\.]/g, ""), props.index)} />
                                        <span>*</span>
                                        <input type="email" className="form-control" name="installment_price" value={props.installment_price} onChange={(e) => props.handleChange1(e.target.name, e.target.value.replace(/[^0-9\.]/g, ""), props.index)} />
                                        <span>=</span>
